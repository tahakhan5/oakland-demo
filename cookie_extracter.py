			...
			if captive_page == 1:
				...
				if self.path == "/usr_cookie_attack_page.html":
						...
						if self.client_address[0] in cookie_dict:
							...
							if self.path == "/usr_cookie_attack_page.html": #send html response
								...
								self.wfile.write("<p>&nbsp;</p><h1 style=\"text-align:center\"><span style=\"font-family:arial,helvetica,sans-serif\"><big><span style=\"font-size:60px\"><strong><span style=\"color:#0066ff\">G</span><span style=\"color:#FF0000\">o</span><span style=\"color:#FFD700\">o</span><span style=\"color:#0066ff\">g</span><span style=\"color:#00cc33\">l</span>"\
									...
									"<span style=\"color:#0066ff\"><u><strong>The Talk</strong></u>&nbsp;</span></span></span></td></tr><tr><td style=\"text-align:justify\"><p><span style=\"font-family:arial,helvetica,sans-serif\"><span style=\"font-size:20px\">This page provies a demonstration of the research by Suphannee Sivakorn, Iasonas Polakis, and Angelos D. Keromytis from"\
									...
									"<table align=\"center\" border=\"0\" cellpadding=\"1\" cellspacing=\"15\" style=\"width:800px\"><tbody><tr><td><span style=\"font-family:arial,helvetica,sans-serif\"><span style=\"color:#0066ff\"><u><strong><span style=\"font-size:28px\">Extracted Information</span></strong></u></span></span></td></tr><tr><td style=\"text-align:justify\">"\
					...
					self.wfile.write("<p>&nbsp;</p><img id=\"demoImg\" src=\"https://example.com/whatever.png\" style=\"width:1px;height:1px\"><h1 style=\"text-align:center\"><span style=\"font-family:arial,"\
						...
						"line-block;cursor:pointer;color:#ffffff;font-family:Arial;font-size:20px;padding:14px 37px;text-decoration:none;}</style><button id=\"demoBtn\" class=\"mybutton\">View Extracted Information</button><script>document.getElementById(\"demoBtn\").onclick="\
